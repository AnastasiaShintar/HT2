...
public class DBWorker {
    ...
    public ResultSet getDBData(String query) {
        ...
        try {
            ...
            connect = DriverManager.getConnection("jdbc:mysql://localhost/phonebook?user=root&password=root&useSSL=false&useUnicode=true&characterEncoding=UTF-8&characterSetResults=utf8&connectionCollation=utf8_general_ci");
